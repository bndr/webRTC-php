...
<div id="chat_wrap" class="span8 chat_box">
	...
	<div class="row">
		...
		<button onclick="send_message();" class="input-chat-button"><i class="icon-upload"></i></button>	
	</div>
		</div>
	</div>
</div>
...
<script src="crypt.js"></script>
    <script src="adapter.js"></script> <!-- For Crossbrowser RTCPeerconnection. Helps a lot. -->
    <script src="chat.js"></script> <!-- Main js file. -->
</html>
